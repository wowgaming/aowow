...
CLISetup::registerSetup("sql", new class extends SetupScript
{
    ...
    public function generate(array $ids = []) : bool
    {
        ...
        // $rows = DB::World()->select('SELECT `spellid0`, `spellid1`, `spellid2`, `spellid3` FROM spelldifficulty_dbc'); // TC
        $rows = DB::World()->select('SELECT DifficultySpellID_1, DifficultySpellID_2, DifficultySpellID_3, DifficultySpellID_4 FROM spelldifficulty_dbc'); // AC
        foreach ($rows as $r)
