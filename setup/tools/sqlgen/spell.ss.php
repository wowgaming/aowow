...
CLISetup::registerSetup("sql", new class extends SetupScript
{
    ...
    public function generate(array $ids = []) : bool
    {
        $ssQuery = 'SELECT
                           ...
                           EffectRadiusIndex_1 AS effect1RadiusMin,
                           0 AS effect1RadiusMax,
                           EffectRadiusIndex_2 AS effect2RadiusMin,
                           0 AS effect2RadiusMax,
                           EffectRadiusIndex_3 AS effect3RadiusMin,
                           0 AS effect3RadiusMax,                           EffectAura_1 AS EffectApplyAuraName1,                         EffectAura_2 AS EffectApplyAuraName2,                      EffectAura_3 AS EffectApplyAuraName3,
        ...
        */
        ...
        DB::Aowow()->query('UPDATE ?_spell SET reqSpellId = id WHERE id IN (?a)', [9788, 9787, 20222, 20219, 10660, 10656, 10658, 26797, 26798, 26801, 17039, 17040, 17041]); // AC
